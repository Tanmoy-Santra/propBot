    ...
    const fetchProperties = async () => {
      try {
        ...
        const forRent = data.filter(
          (p) => parseInt(p.id, 10) >= 1 && parseInt(p.id, 10) <= 20
        );
      ...
      <div className="p-2">
        <img
          ...
          onError={(e) => {
            ...
            e.target.src =
              "https://placehold.co/500x400/CCCCCC/000000?text=No+Image";
          }}
        />
      </div>
          ...
          <>
            <div className="mb-12">
              ...
              <div className="relative">
                <div
                  ref={saleScrollRef}
                  className="flex overflow-x-auto snap-x snap-mandatory pb-4 no-scrollbar"
                >
                ...
                <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between px-4 z-10 pointer-events-none">
                  <button
                    ...
                    className="pointer-events-auto bg-gray-800 text-white rounded-full p-2 hover:bg-gray-700 focus:outline-none"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
            ...
            <div className="mb-12">
              <div className="flex font-Poppins flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div>
                  ...
                  <p className="mt-2 text-[#555555] max-w-2xl">
                    Explore our listings for rent and find the ideal place for
                    you and your family.
                  </p>
                </div>
              </div>
              <div className="relative">
                ...
                <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between px-4 z-10 pointer-events-none">
                  <button
                    onClick={() => scroll(rentalScrollRef, "left")}
                    className="pointer-events-auto bg-gray-800 text-white rounded-full p-2 hover:bg-gray-700 focus:outline-none"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    onClick={() => scroll(rentalScrollRef, "right")}
                    className="pointer-events-auto bg-gray-800 text-white rounded-full p-2 hover:bg-gray-700 focus:outline-none"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
